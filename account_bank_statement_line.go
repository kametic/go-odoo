...
type AccountBankStatementLine struct {
	...
	MercuryCardBrand          *String    `xmlrpc:"mercury_card_brand,omptempty"`
	MercuryCardNumber         *String    `xmlrpc:"mercury_card_number,omptempty"`
	MercuryCardOwnerName      *String    `xmlrpc:"mercury_card_owner_name,omptempty"`
	MercuryInvoiceNo          *String    `xmlrpc:"mercury_invoice_no,omptempty"`
	MercuryPrefixedCardNumber *String    `xmlrpc:"mercury_prefixed_card_number,omptempty"`
	MercuryRecordNo           *String    `xmlrpc:"mercury_record_no,omptempty"`
	MercuryRefNo              *String    `xmlrpc:"mercury_ref_no,omptempty"`
	...
	PosStatementId            *Many2One  `xmlrpc:"pos_statement_id,omptempty"`
